...
"""
Identify technical replicates among the EM BON metagenomes.
...
e.g.
EMOBON_AAOT_Wa_1 and EMOBON_AAOT_Wa_2 are technical replicates

Do from technical_replicates import REPLICATES
