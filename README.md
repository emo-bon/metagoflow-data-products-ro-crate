...
-  *target_directory* is a directory of compress results archives with a filename format matching: "HMNJKDSX3.UDI198.tar.bz2"
...
- -w without sequence data Do not add sequence data files (default: False)
